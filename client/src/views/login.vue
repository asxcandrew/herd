  ...
  <div id="login">
    ...
    <el-form ref="form" :model="form" :rules="rules">
      ...
      <el-form-item prop="password">
        <el-input type="password" v-model="form.password" placeholder="Password" maxlength=20></el-input>
      </el-form-item>
    </el-form>
    <p>
      {{ $t("views.login.signUpProposal") }}
      <el-button type="text" @click="loginDialogVisible = true">{{ $t("views.login.signUpButton") }}</el-button>.
    </p>
  </div>
</template>
